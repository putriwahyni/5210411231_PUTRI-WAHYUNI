...
m1 = Mahasiswa1('Angkasa','521041543','Teknik Sipil',2018)
...
m2 = Mahasiswa('Aurora','10120445','Arsitektur',2021)
teks = '{} adalah mahasiswa {} angkatan {} dengan nim {}'.format(m2.nama,m2.prodi,m2.thn_masuk,m2.nim)
print(teks)
...
buku = Buku1('Rumah Kaca','Pramoedya Ananta Toer',2010)
...
buku = Buku2('Laskar Pelangi','Andrea Hirata',2005)
b = 'Buku {} karangan {} pertama kali terbit {}'.format(buku.judul,buku.pengarang,buku.tahun_terbit)
print(b)