# -*- coding: utf-8 -*-
"""Program PBOVII P-4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EigpgTYwgVWmzcrYDVbn1gi7scf-4kZm
"""
...
mnm3 = menuminuman("Jus Alpukat Xtra Milk",'Jus Alpukat dengan susu coklat',15000,40)
...
for mn in pilihan:
    t = '{} harga Rp {},{},{}'.format(mn.nama,mn.harga,mn.deskripsi,mn._menuminuman__stok)
    print(t)
...
m1 = Mahasiswa('Udin','10120371','Sistem Informasi',2020,4.00,2500000)
...
#class buku
class Buku:
    def __init__(self,judul,pengarang,tahun_terbit,harga,nomor):
        self.judul = judul
...
buku = Buku('Tenggelamnya Kapal Van Der Wijck','HAMKA', 1938, 90000,20)
t = 'Buku {} karangan {} pertama kali terbit {} dengan harga {} dan stok {}'.format(buku.judul,buku.pengarang,buku.tahun_terbit,buku._Buku__harga,buku._Buku__nomor)
print(t)